...
@Schema(description = "Banking: Transaction Type", enumAsRef = true)
public enum BankingTransactionType implements LabelValueEnumInterface {
  ...
  public static BankingTransactionType fromValue(String text)
    ...
    throw new LabelValueEnumValueNotSupportedException(
        "Unable to identify value of BankingTransactionType from " + text,
        BankingTransactionType.class.getSimpleName(), BankingTransactionType.values(), text);
  }
