...
@Schema(description = "Banking Product Categories", enumAsRef = true)
public enum BankingProductCategory implements LabelValueEnumInterface {
  ...
  public static BankingProductCategory fromValue(String text)
    ...
    throw new LabelValueEnumValueNotSupportedException(
        "Unable to identify value of BankingProductCategory from " + text,
        BankingProductCategory.class.getSimpleName(), BankingProductCategory.values(), text);
  }
