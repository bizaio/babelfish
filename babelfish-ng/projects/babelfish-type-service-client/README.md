...
In your project:
```
npm link @bizaoss/babelfish-type-service-client
```
...
import { ApiModule } from '@bizaoss/babelfish-type-service-client';
...
import { ApiModule, Configuration, ConfigurationParameters } from '@bizaoss/babelfish-type-service-client';
...
```
import { DefaultApi } from '@bizaoss/babelfish-type-service-client';
...
```
import { BASE_PATH } from '@bizaoss/babelfish-type-service-client';
