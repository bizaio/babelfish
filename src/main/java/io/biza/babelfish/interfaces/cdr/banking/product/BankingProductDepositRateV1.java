...
@FreeBuilder
@JsonDeserialize(builder = BankingProductDepositRateV1.Builder.class)
public interface BankingProductDepositRateV1 {
   ...
   *
   */
  class Builder extends BankingProductDepositRateV1_Builder {}
  ...
  public BankingProductDepositRateType type();
