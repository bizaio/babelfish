...
public interface BankingProductV1 {
  ...
  public default BankingProductV1 productId(String productId) {
  ...
  public default BankingProductV1 effectiveFrom(OffsetDateTime effectiveFrom) {
  ...
  public default BankingProductV1 effectiveTo(OffsetDateTime effectiveTo) {
  ...
  public default BankingProductV1 lastUpdated(OffsetDateTime lastUpdated) {
  ...
  public default BankingProductV1 productCategory(BankingProductCategory productCategory) {
  ...
  public default BankingProductV1 name(String name) {
    setName(name);
    return this;
  }
  ...
  public default BankingProductV1 description(String description) {
  ...
  public default BankingProductV1 brand(String brand) {
    setBrand(brand);
    return this;
  }
  ...
  public default BankingProductV1 brandName(String brandName) {
  ...
  public default BankingProductV1 applicationUri(URI applicationUri) {
  ...
  public default BankingProductV1 tailored(Boolean isTailored) {
  ...
  public default BankingProductV1 additionalInformation(BankingProductAdditionalInformationV1 additionalInformation) {
