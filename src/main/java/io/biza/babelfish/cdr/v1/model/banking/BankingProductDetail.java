...
public class BankingProductDetail
    extends io.biza.babelfish.cdr.model.banking.product.BankingProductDetail<BankingProductDetail> {
  ...
  @Override
  public BankingProductDetail cardArt(List<BankingProductCardArt<?>> cardArt)
