...
public class BankingProductV1
    extends io.biza.babelfish.cdr.abstracts.payloads.banking.product.BankingProduct<BankingProductV1> {
  ...
  @Override
  public BankingProductV1 cardArt(List<BankingProductCardArt<?>> cardArt)
