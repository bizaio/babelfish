...
public class BankingProductDiscount
    extends io.biza.babelfish.cdr.abstracts.payloads.banking.product.BankingProductDiscount<BankingProductDiscount> {
  ...
  @AssertTrue(message = "Additional Value should be null when Discount Type is ELIGIBILITY_ONLY")
