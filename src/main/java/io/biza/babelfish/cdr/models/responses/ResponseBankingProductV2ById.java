...
import io.biza.babelfish.cdr.abstracts.payloads.banking.product.BankingProductDetail;
...
@Data
public class ResponseBankingProductV2ById extends CDRResponse<ResponseBankingProductV2ById> {
  ...
  public ResponseBankingProductV2ById data(BankingProductDetailV2 data) {
    setData(data);
    return this;
  }
}
