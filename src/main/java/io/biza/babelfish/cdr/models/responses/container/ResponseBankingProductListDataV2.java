...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Object containing a list of BankingProduct objects", name = "ResponseBankingProductListDataV2")
public class ResponseBankingProductListDataV2 {
  @Schema(
