...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Response containing a list of Banking Accounts", name = "ResponseBankingAccountListDataV1")
public class ResponseBankingAccountListDataV1 {
  @Schema(
  ...
  @NotNull
  @Valid
  List<BankingAccountV1> accounts;
