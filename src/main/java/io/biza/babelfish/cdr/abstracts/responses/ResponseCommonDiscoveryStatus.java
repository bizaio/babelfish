...
import io.biza.babelfish.cdr.abstracts.responses.container.CommonDiscoveryStatus;
...
@Schema(name = "ResponseCommonDiscoveryStatus", description = "Common Discovery Status")
