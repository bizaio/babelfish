...
public interface BankingScheduledPaymentRecurrenceEventBased {
  ...
  public default BankingScheduledPaymentRecurrenceEventBased description(@NotNull String description) {
