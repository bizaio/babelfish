...
import io.biza.cdr.babelfish.enumerations.BankingTransactionStatus;
import io.biza.cdr.babelfish.enumerations.BankingTransactionType;
...
public class BankingTransaction {
    ...
    @BabelFishModelProperty(description = "ID of the account for which transactions are provided", required = true)
    @NonNull
    @NotNull
    String accountId;

    @BabelFishModelProperty(description = "A unique ID of the transaction adhering to the standards for ID permanence. ")
    @NonNull
    @NotNull
    ...
    @BabelFishModelProperty(description = "The transaction description as applied by the financial institution", required = true)
    @NonNull
    @NotNull
    String description;
    ...
    @BabelFishModelProperty(description = "The time the transaction was executed by the originating customer, if available")
    @JsonSerialize(converter = OffsetDateTimeToDateTimeStringConverter.class)
    @JsonDeserialize(converter = DateTimeStringToOffsetDateTimeConverter.class)
    private LocalDateTime executionDateTime;

    @BabelFishModelProperty(description = "The value of the transaction. Negative values mean money was outgoing from the account",
    ...
    @BabelFishModelProperty(description = "The currency for the transaction amount. AUD assumed if not present",
    ...
    @BabelFishModelProperty(description = "Name of the merchant for an outgoing payment to a merchant")
    String merchantName;

    @BabelFishModelProperty(description = "The merchant category code (or MCC) for an outgoing payment to a merchant")
    String merchantCategoryCode;

    @BabelFishModelProperty(description = "BPAY Biller Code for the transaction (if available)")
    String billerCode;

    @BabelFishModelProperty(description = "Name of the BPAY biller for the transaction (if available)")
    String billerName;
    ...
    private boolean isPostedDateDefined() {
        return BankingTransactionStatus.POSTED.equals(status) ? (postingDateTime != null ? true : false) : true;
    }
