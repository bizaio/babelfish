...
@Valid
public class ResponseBankingAccountById extends io.biza.cdr.babelfish.response.ResponseBankingAccountById {

  public ResponseBankingAccountById(@NonNull BankingAccountDetail data,
