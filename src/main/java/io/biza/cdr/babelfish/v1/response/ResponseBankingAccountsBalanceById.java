...
@Valid
public class ResponseBankingAccountsBalanceById extends io.biza.cdr.babelfish.response.ResponseBankingAccountsBalanceById {

    public ResponseBankingAccountsBalanceById(@NonNull BankingBalance data,
