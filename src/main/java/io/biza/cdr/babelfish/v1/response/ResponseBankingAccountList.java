...
@Valid
public class ResponseBankingAccountList extends io.biza.cdr.babelfish.response.ResponseBankingAccountList {

  public ResponseBankingAccountList(@NonNull ResponseBankingAccountListData data,
