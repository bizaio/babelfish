...
@DisplayName("ResponseBankingPayeeList V1 Tests")
public class ResponseBankingPayeeListV1Test {
  ...
  @Test
  @DisplayName("Create valid ResponseBankingPayeeList")
  void bankingPayeeListResponse() {
