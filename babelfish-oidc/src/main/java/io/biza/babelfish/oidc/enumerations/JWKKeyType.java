...
public enum JWKKeyType {
	...
	public static JWKKeyType fromNimbus(KeyType type) {
	...
	public static JWKKeyType fromNimbus(JWSAlgorithm algorithm) {
		return fromNimbus(KeyType.forAlgorithm(algorithm));
	}

	public static JWKKeyType fromAlgorithm(JWSSigningAlgorithmType algorithm) {
